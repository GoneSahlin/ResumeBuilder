...
export function Educations(register: UseFormRegister<any>, unregister: UseFormUnregister<any>) {
  const fields: Array<Field> = [
    {name: "educationName", label: "School Name:"},
    {name: "educationLocation", label: "Location:"},
    {name: "educationStartDate", label: "Start Date:"},
    {name: "educationEndDate", label: "End Date:"},
    {name: "educationMajor", label: "Major:"},
  ];

  return (
    <>
      {CVSection("Education", fields, register, unregister)}
    </>
  );
};