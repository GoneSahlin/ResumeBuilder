    ...
    def test_add_education(self):
        ...
        resume.add_education(
            ...
            [
                ...
                "President's List: 3 semesters, Dean's List: 4 semesters",
            ],
        )
    ...
    def test_add_project(self):
        ...
        resume.add_project(
            ...
            [
                ...
                "Collects data on historical rental prices, crime data, and school scores.",
                "Predicts future rental prices with an LSTM.",
                "Leverages a REST API to connect the web app to the mySQL database.",
    ...
    def test_from_cv_and_ids(self):
        cv = {
            "educations": [
                {
                    "id": "0",
                    "educationName": "Gonzaga University",
                    "educationLocation": "Spokane, WA",
                    "educationStartDate": "August 2019",
                    "educationEndDate": "May 2023",
                    "educationMajor": "BS in Computer Science, Minor in Applied Mathematics",
                    "bullets": [
            ...
            "projects": [
                {
                    "id": "0",
                    "projectTitle": "Machine Learning for Real Estate",
                    "projectTools": "Python, SQL, PyTorch, JS, Fast API",
                    "projectDate": "Fall 2022 - Spring 2023",
                    "projectUrl": "",
                    "bullets": [
                        "Senior Design Project",
                        "Collects data on historical rental prices, crime data, and school scores.",
                ...
                },
                {
                    ...
                    "projectTools": "Python, TensorFlow, AWS Lambda, AWS EventBridge, selenium",
                    "projectDate": "Spring 2023",
                    "projectUrl": "https://github.com/GoneSahlin/StocksAI",
                    "bullets": [
                ...
                {
                    "id": "2",
                    "projectTitle": "Image Resizing CDN",
                    "projectTools": "Python, AWS CloudFront, AWS Lambda, AWS S3, AWS CDK",
            ...
            "research": [
                {
                    "id": "0",
                    "researchTitle": "Long Span Truss Analysis and Optimization",
                    "researchTools": "MATLAB",
                    "researchDate": "Spring 2023",
                    "researchUrl": "",
                    "bullets": [
                        "Worked with Dr. Sara Ganzerli and civil engineering students.",
                        "Developed a script to analyze and optimize a truss to minimize material use within the load constraints.",
            ...
            "workExperience": [
                {
                    "id": "0",
                    "workExperienceTitle": "Teaching Assistant",
                    "workExperienceEmployer": "Gonzaga University",
                    "workExperienceStartDate": "August 2022",
                    "workExperienceEndDate": "May 2023",
                    "bullets": [
                        "Teaching assistant for Operating Systems, Computer Security, and Internet of Things.",
                        "Graded programming and written assignments.",
                    ],
                ...
                {
                    "id": "1",
                    "workExperienceTitle": "Online Private Instructor",
                    "workExperienceEmployer": "iD Tech",
                    "workExperienceStartDate": "June 2021",
                    "workExperienceEndDate": "August 2022",
                    "bullets": [
                        "Tutored in 8 different computer science topics, including C++, Java, and Python.",
                        "Completed over 200 private lessons.",
                        "Formed relationships with long-term clients, and further developed skills in communication and coding.",
        ...
        ids = {
            ...
            "projectIds": ["2", "1", "0"],
            "researchIds": ["0"],
            "workExperienceIds": ["0", "1"],
            "relatedCourseworkIds": ["1", "3"],
            "technicalSkillsIds": ["1", "2"],
        }
